...
class FlightSeatsInfosTest {
    ...
    fun findFlightSeatInfos_Success() {
        ...
        val itineraryInfoRequestDto = ItineraryInfoRequestDto(
            schedule = Date.valueOf(schedule),
        ...
        whenever(flight.departureTime).thenReturn(Timestamp(System.currentTimeMillis()))
        whenever(flight.arrivalTime).thenReturn(Timestamp(System.currentTimeMillis()))
